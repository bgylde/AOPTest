    ...
    public void visitInsn(int opcode) {
        if (((opcode >= IRETURN && opcode <= RETURN) || opcode == ATHROW)) {
            if (defaultOkhttpClientBuilderInitMethod) {
                ...
                // mv.visitMethodInsn(INVOKESTATIC, "com/bgylde/agent/okhttp/OkHttpHooker", "getInstance", "()Lcom/bgylde/agent/okhttp/OkHttpHooker;", false);
                // mv.visitMethodInsn(INVOKEVIRTUAL, "com/bgylde/agent/okhttp/OkHttpHooker", "getOkhttpDns", "()Lokhttp3/Dns;", false);
                ...
                mv.visitMethodInsn(INVOKESTATIC, "com/bgylde/agent/okhttp/OkHttpHooker", "getInstance", "()Lcom/bgylde/agent/okhttp/OkHttpHooker;", false);
                mv.visitMethodInsn(INVOKEVIRTUAL, "com/bgylde/agent/okhttp/OkHttpHooker", "getGlobalInterceptors", "()Ljava/util/List;", false);
                ...
                mv.visitMethodInsn(INVOKESTATIC, "com/bgylde/agent/okhttp/OkHttpHooker", "getInstance", "()Lcom/bgylde/agent/okhttp/OkHttpHooker;", false);
                mv.visitMethodInsn(INVOKEVIRTUAL, "com/bgylde/agent/okhttp/OkHttpHooker", "getGlobalNetworkInterceptors", "()Ljava/util/List;", false);
                mv.visitMethodInsn(INVOKEINTERFACE, "java/util/List", "addAll", "(Ljava/util/Collection;)Z", true);
                mv.visitInsn(POP);
                ...
                if (Type.VOID_TYPE != returnType) {
                    ...
                    mv.visitInsn(LSUB);
                    mv.visitMethodInsn(INVOKESTATIC, "com/bgylde/agent/debug/OkHttpDnsUtils", "handleDnsList", "(Ljava/util/List;J)V", false);
                    mv.visitVarInsn(loadOpcode, resultTempValIndex);
                }
