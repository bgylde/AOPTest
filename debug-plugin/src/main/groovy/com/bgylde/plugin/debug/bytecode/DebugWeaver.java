...
import com.bgylde.plugin.debug.bytecode.prescan.DebugPreClassAdapter;
import com.bgylde.transform.asm.BaseWeaver;
import com.bgylde.transform.asm.ExtendClassWriter;
...
public class DebugWeaver extends BaseWeaver {
    ...
    private static final String PLUGIN_LIBRARY = "com.bgylde.agent.debug";
